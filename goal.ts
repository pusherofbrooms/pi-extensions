...
import type { GoalAgentReport, GoalCriterion, GoalIndex, GoalIteration, GoalRoleCheckpoint, GoalRuntimeDeps, GoalScaffold, GoalSubagentRole, GoalSubagentSessionRef, StoredGoal } from "./goal-types.ts";
